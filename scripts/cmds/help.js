...
const doNotDelete = "[ ☆ |𝐝𝐚𝐧 𝐣𝐞𝐫𝐬𝐞𝐲 𝐭𝐡𝐞 𝐠𝐨𝐚𝐭 | ☆]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
module.exports = {
	config: {
		name: "help",
		version: "1.17",
...
msg += `𝐅𝐛: https://www.facebook.com/Deving8g9d35☆ `;
